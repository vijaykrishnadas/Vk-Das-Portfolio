        ...
        <div className="about">
            <div className="about-wrapper">
                ...
                <span><FontAwesomeIcon icon={faSmile} className="about-icon"></FontAwesomeIcon><span className="about-text">about me</span></span>
                    ...
                    A Web/App Designer and a Full Stack Developer <br />
